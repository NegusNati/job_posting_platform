  ...
  <form method="POST" action="/jobs">
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <p class="mt-1 text-sm leading-6 text-gray-600">We just need some information and it will be displayed publicly so be careful what
          you share.</p>
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            ...
            <p class="mt-3 text-sm leading-6 text-gray-600">Write a few sentences describing the Job, and related
              benefits.</p>
          </div>
